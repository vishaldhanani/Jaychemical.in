<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ActOverDueSummaryNew.aspx.cs" Inherits="ActOverDueSummaryNew" %>
...
<body>
    ...
    <header>
        ...
        <a href="DashBoard.aspx"><img src="images/logo.png" class="inner-logo" /></a>
            <div class="inner_logo">
            	<a >Overdue  <br /> <asp:Label runat="server" CssClass="lblUser1" ID="lblUserName"></asp:Label></a>
            </div>
    ...
    <div id="middle">
        <div class="wrap">
            ...
            <div>
                <asp:Repeater runat="server" ID="rpt_Account_Stmt" OnItemDataBound="rpt_OverDue_ItemDataBound" >                                      
                    <HeaderTemplate>
                    ...
                    <ItemTemplate>
                        <tr>                          
                            ...
                            <td align="right" id="tddate" valign="top"  width="50%" > <div style="font-size:13px; font-weight:bold; "> <%# Eval("Amount", "{0:0,00}") %> </div> <a style="font-size:12px; color:#000; text-decoration:none;"> <%# Convert.ToDateTime(Eval("DueDate")).ToString("dd/MM/yy") %></a></td>                                                                                 
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
                             <tr>
    ...
    <footer>
        <div class="fl_icon" ><a  href="ActCustomerOverDue.aspx"><i class="fa fa-2x fa-arrow-circle-o-left" aria-hidden="true"></i></a></div>
    	<div class="wrap">        	
        </div>       
    </footer>
</main>
