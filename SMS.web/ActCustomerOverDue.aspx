<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ActCustomerOverDue.aspx.cs" Inherits="ActCustomerOverDue" %>
        ...
        <div id="middle" class="tz-middle-pad">
            <div class="wrap">                                                
                ...
                <div class="block_1">                	                                    	
                    ...
                    <asp:Repeater runat="server" ID="rpt_Customer" OnItemDataBound="rpt_Customer_Overdue_ItemDataBound">
                        <HeaderTemplate>
                            <ul>
                        </HeaderTemplate>
                        <ItemTemplate>
                            <li>
                                <a runat="server" style="text-decoration:none;" id="a_link" >                                   
                                    ...
                                    <div class="Overduenew" style="text-align:right; font-weight:600;">(<i class="fa fa-inr" aria-hidden="true"></i>)&nbsp;<%# Eval("Custbalance", "{0:0,00}") %></div>
