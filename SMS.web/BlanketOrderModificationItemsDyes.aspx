<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BlanketOrderModificationItemsDyes.aspx.cs" Inherits="BlanketOrderModificationItemsDyes" %>
...
<body>
	...
	<header>
	  <div class="wrap">
		...
		<div class="inner_logo"><a>BLANKET ORDER EDIT<br /> <asp:Label runat="server"  CssClass="lblUser" style="margin-top:10px; vertical-align:top; font-size:10px;" ID="lblUserName"></asp:Label></a> </div>
