...
public partial class ActCustomerTotalOutStanding : System.Web.UI.Page
{
    #region PageEvents
    ...
    protected void rpt_Customer_TotalOutStanding_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        try
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (a_link != null)
                {
                    a_link.HRef = "ActTotalOutStandingSummaryNew.aspx?Customer=" + Convert.ToString(DataBinder.Eval(e.Item.DataItem, "CustomerNo")) + "&Name=" + Convert.ToString(DataBinder.Eval(e.Item.DataItem, "Name")) + "";
                }
            }
        }
        catch (Exception ex)
