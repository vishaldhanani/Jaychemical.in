...
public partial class ActDueInNext7DaySummaryNew : System.Web.UI.Page
{
        ...
        try
        {
            ...
            if (list != null && list.Count > 0)
            {
                ...
                else
                {
                    ...
                    rpt_Account_Stmt.DataBind();
                    // l_Error.Text = "Due In Next 7 Days Detail is not found.";
    ...
    protected void rpt_DueNext7Days_Summary_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        try
        {
