<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrderPlacementCartList.aspx.cs" Inherits="OrderPlacementCartList" %>
    ...
    <%--  <script type="text/javascript">
        ...
        function validateCustRefNo() {
            if (!form1.txtCustomerReferenceNo.value) {
                ...
                var textbox = document.getElementById("txtCustomerReferenceNo");
                textbox.focus();
                return (false);
            }
        ...
        <div class="wrap">
            ...
            <div>
                <asp:Repeater runat="server" ID="rpt_FinalCart" OnItemDataBound="rpt_FinalCart_ItemDataBound">
                    ...
                    <ItemTemplate>
                        <tr>
                             <td align="Left" valign="LEFT" style="font-size:11px; font-weight:600;"><%# Container.ItemIndex + 1 %>. &nbsp;<%# Eval("ProductName") %> <br /> <a style="font-size:9px; text-align:left;"> - (<%# Eval("VariantCode") %>) </a></td>                            
                            <td align="right" valign="top">
                                <%# Eval("Quantity") %>                                 
                               <br /><a style="font-size:9px; text-align:right; padding:3px 0;">(<%# Eval("UOM") %>)</a></td>                                                     
                                <td align="right"  valign="top"><%# Math.Round(Convert.ToDecimal(Eval("CSellingPrice"))) %> </td>                                                                                                                                                                                                                                                             
