<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BlanketOrderModificationItems.aspx.cs" Inherits="BlanketOrderModificationItems" %>
...
<body>
    ...
    <header>
        <div class="wrap">       
            <a id="lbl_home_logo"  runat="server"  href="DashBoard.aspx"><img src="images/logo.png" class="inner-logo"/></a>
                    <div class="inner_logo"><a>Blanket Order Edit <br /> <asp:Label runat="server" CssClass="lblUser1" ID="lblUserName"></asp:Label></a>                        
                    </div>
                        ...
                        <div>
                            <table width="100%" border="0" >
                                                ...
                                                <td width="100%"  align="left" valign="top">
                                                        ...
                                                        <span id="Span5"> 
                                                            <asp:DropDownList runat="server" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" ID="dd_Variant" TabIndex="1" AutoPostBack="true"  CssClass="u_oder_fill_white_label order_pack" >                                                            
                                    ...
                                    <tr>                                                
                                        ...
                                        <td width="100%" align="left" valign="top">
                                            ...
                                            <b><asp:TextBox runat="server" ID="tb_Price" BackColor="#efefef" Placeholder="Price" CssClass="u_oder_fill_white_label" ReadOnly="true" Style="text-align:right;"  Text='<%# (Convert.ToDecimal(Eval("UnitPrice"))).ToString("0.00") %>'></asp:TextBox>                                                               </b>                             
                                            </span>
                                            </div>
                                        </td>
                                    </tr>
                                 ...
                                 <tr runat="server" id="tr_condition" >
                                        ...
                                        <span id="Span14">
                                            ...
                                            <asp:TextBox runat="server" ID="tb_Discount" BackColor="#efefef"  Style="text-align:right;" placeholder="Discount" Text='<%# System.Math.Round(Convert.ToDecimal(Eval("Discount"))).ToString("0") %>'  ReadOnly="true" CssClass="u_oder_fill_white_label"></asp:TextBox>
                                    ...
                                    <tr>                                                
                                        ...
                                        <td width="100%" align="left" valign="top">
                                         <div class="blk_1">                               
                                            ...
                                            <asp:TextBox runat="server" ID="txt_Customerprice" Text='<%# (Convert.ToDecimal(Eval("UnitPrice"))).ToString("0.00") %>' onkeyup="checkDec(this);" Style="text-align:right;"  BackColor="#efefef" TabIndex="3" Placeholder="Cust. Price" CssClass="u_oder_fill_white_label" ></asp:TextBox>                                                                                           
    ...
    <footer>
        <div class="fl_icon"><a href="BlanketOrderModificationView.aspx?OrderNo=<%=Request.QueryString["OrderNo"]%> &PostingDate=<%= Convert.ToString(Request.QueryString["PostingDate"]) %> "><i class="fa fa-2x fa-arrow-circle-o-left" aria-hidden="true"></i></a></div>                 
    	<div class="wrap">        	        
        <div class="links">           
