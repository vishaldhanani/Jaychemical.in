...
<body style="overflow: hidden; position: relative;">
    <form runat="server" id="frm_dashboard" method="get">
        ...
        <main>
    <header>     
      <div class="wrap"> <img class="inner-logo"  src="images/logo.png" />
        <div class="inner_logo"><a>Dashboard <br /> <asp:Label runat="server" CssClass="lblUser1" ID="lblUserName"></asp:Label></a> </div>         
        <div class="logout-btn">
            <a href="Login.aspx" class="bt_Logout1"  onclick="return confirm('Are you sure to logout?');" ><i  class="fa fa-2x fa-sign-out" aria-hidden="true"></i>                                      
            </a>
        </div>                   
      </div>
        <a style="float:right; padding-top:5px; font-size:11px; color:black; width:200px; padding-left:20px; margin-right:-50px; color:#8A0886;"><b>Last Login:&nbsp;</b><asp:Label  runat="server" CssClass=""  ID="lblLastLoginTime"  style="font-size:11px; font-weight:bold; color:black;" Text=""></asp:Label></a>
    ...
    <footer>
      <div style="font-size:18px; color:#FFF; text-align:center; vertical-align:middle; margin-top:15px; font-style:italic; ">We are just one click away          
      </div>
    </footer>
