...
public partial class ActCustomerOverDue : System.Web.UI.Page
{
    #region PageEvents
    ...
    private void BindCustomerWiseBalance()
    {
        try
        {
            List<CustomerwiseBalance> list = CustomerwiseBalance.ListOverDue(SessionManager.GetAgentCode(HttpContext.Current));
    ...
    #region Events
    protected void rpt_Customer_Overdue_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        try
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (a_link != null)
                {                    
                    a_link.HRef = "ActOverDueSummaryNew.aspx?Customer=" + Convert.ToString(DataBinder.Eval(e.Item.DataItem, "CustomerNo")) + "&Name=" + Convert.ToString(DataBinder.Eval(e.Item.DataItem, "Name")) + "";                    
                }
            }
        }
        catch (Exception ex)
