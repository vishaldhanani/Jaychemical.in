...
public partial class ActCustomerAccountStatement : System.Web.UI.Page
{
    #region PageEvents
    ...
    protected void rpt_Customer_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        try
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (a_link != null)
                {
                    a_link.HRef = "SendMail_Customers.aspx?CustomerNo=" + Convert.ToString(DataBinder.Eval(e.Item.DataItem, "CustomerNo"));
                }
            }
        }
        catch (Exception ex)
