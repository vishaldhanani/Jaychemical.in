...
public partial class InternalMakeOrderView : System.Web.UI.Page
{
    #region Variable
    ...
    private void BindCustomerInfo()
    {
        try
        {
            Qtm.Lib.OrderModifiCustomerInfo obj = Qtm.Lib.OrderModifiCustomerInfo.InternalFind(Convert.ToString(Request["OrderNo"]));
            if (obj != null)
            {
