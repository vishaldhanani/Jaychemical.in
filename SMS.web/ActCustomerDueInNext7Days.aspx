<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ActCustomerDueInNext7Days.aspx.cs" Inherits="ActCustomerDueInNext7Days" %>
        ...
        <div id="middle" class="tz-middle-pad">
            <div class="wrap">                   
                ...
                <div class="block_1">
                    ...
                    <asp:Repeater runat="server" ID="rpt_Customer" OnItemDataBound="rpt_Customer_DueInNext7Days_ItemDataBound">
                        <HeaderTemplate>
                            <ul>
                        </HeaderTemplate>
                        <ItemTemplate>
                            <li>
                                <a runat="server" style="text-decoration:none;" id="a_link" >                                   
                                    ...
                                    <div class="Overduenew" style="text-align:right;"><span>(<i class="fa fa-inr" aria-hidden="true"></i>)&nbsp;<%# Eval("Custbalance","{0:0,00}")  %></span></div>
