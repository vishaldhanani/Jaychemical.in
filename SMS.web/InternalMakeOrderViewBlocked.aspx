<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InternalMakeOrderViewBlocked.aspx.cs" Inherits="InternalMakeOrderViewBlocked" %>
...
<body>
    ...
    <div id="middle">
        <div class="wrap">
            ...
            <div class="odr_place_address_Make_Order" style="padding:1% 0;">                
  ...
  <ul style="box-shadow:none;">
    <li>
      ...
      <div id="one" style="background-color:#000000;  background: #fff; padding: 5px 0;">
        <table width="100%" border="0" style="text-decoration-color:black; width:100%;" class="internal-option"> 
                  ...
                  <tr>
                   ...
                   <tr>
                    ...
                    <td width="70%" align="left" valign="top"><asp:DropDownList ID="drpNoseries" tabindex="1" style="background-color:#ffffff;" runat="server" Width="102%" CssClass="u_oder_fill_white_label order_pack"> 
                        <asp:ListItem  Text="-Select-" Value="0"></asp:ListItem></asp:DropDownList> </td>                                                             
                  </tr>
                  <tr>
                    <td width="30%" align="left" valign="middle" style="font-weight:bold;">Structure :</td>
                    <td width="70%" align="left" valign="top"><asp:DropDownList ID="drpStructure" tabindex="2"  style="background-color:#ffffff;" runat="server" Width="102%" CssClass="u_oder_fill_white_label order_pack"> 
                        <asp:ListItem  Text="-Select-" Value="0"></asp:ListItem></asp:DropDownList></td>                                                               
                  </tr>

                  <tr>
                    <td width="30%" align="left" valign="middle" style="font-weight:bold;">Product Code:</td>
                    <td width="70%" align="left" valign="top"><asp:DropDownList ID="drpProductCode"  tabindex="4" style="background-color:#ffffff;" runat="server" Width="102%" CssClass="u_oder_fill_white_label order_pack">
                        <asp:ListItem  Text="-Select-" Value="0"></asp:ListItem> </asp:DropDownList> </td>                                                              
                  </tr>
                  <tr>
                   ...
                   <asp:HiddenField runat="server" ID="hf_SalesOrder" Value="" />
                    ...
                    <tr style="visibility:hidden" runat="server" id="tr_CForm" >
                ...
                <asp:Repeater runat="server" ID="rpt_FinalCart" OnItemDataBound="rpt_FinalCart_ItemDataBound">
                    <HeaderTemplate>
                        <table width="100%" border="1" class="odr_tbl_list1">
                            <tr>
                                ...
                                <th width="24%" align="center" valign="middle">Discount %</th>                                <th width="18%" align="center" valign="middle">QTY To Ship</th>                                
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td align="left"  valign="top"><asp:TextBox runat="server" ReadOnly="true"  tabindex="12" ID="dd_TaxGroupCode" Style="text-align:center; " Width="90%" Height="20px" ></asp:TextBox></td>
                            <td align="right"  valign="top"><asp:DropDownList runat="server" tabindex="13" ID="dd_Excise_PostingGrpCode" Style="text-align:center; background-color:#EFEFEF;" Width="100%" Height="20px" ></asp:DropDownList></td>                                                                                                                                              
                            <asp:HiddenField runat="server" ID="hf_ItemNo" Value='<%# Eval("ItemNo") %>' />
                            <asp:HiddenField runat="server" ID="hf_LineNo" Value='<%# Eval("LineNo") %>' />
                            <asp:HiddenField runat="server" ID="hf_ExciseGroupCode" Value='<%# Eval("ExciseGroupCode") %>' />                            
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>                             
                        </table>
    ...
    <footer>
        <div class="fl_icon"><a runat="server" id="btn_BackLink" href="InternalMakeOrderModification.aspx"><i class="fa fa-2x fa-arrow-circle-o-left" aria-hidden="true"></i></a></div>
    	<div class="wrap">        	        
        <div class="links">          
            <asp:LinkButton runat="server" ID="lb_Update" Visible="false"  CssClass="u_f_btn" OnClick="btn_Update"   Text="Update"  TabIndex="13" ></asp:LinkButton>
