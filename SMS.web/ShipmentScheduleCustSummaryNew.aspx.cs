...
public partial class ShipmentScheduleCustSummaryNew : System.Web.UI.Page
{
    ...
    private void BindShipmentCust_Summary()
    {
        try
        {
            ...
            {
                list = Qtm.Lib.ShipmentCustSummary.ListShipmentCust(SessionManager.GetAgentCode(HttpContext.Current), Request["Code"]);
            }
            else
            {
                //never happen 
    ...
    protected void rpt_Q1Cust_Inv_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        try
        {
