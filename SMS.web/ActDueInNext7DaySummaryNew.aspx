<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ActDueInNext7DaySummaryNew.aspx.cs" Inherits="ActDueInNext7DaySummaryNew" %>
...
<body>
    ...
    <header>
        ...
        <a href="DashBoard.aspx"><img src="images/logo.png" class="inner-logo"/></a>
            <div class="inner_logo" >
            	<a >Due In Next 7 Days <br /> <asp:Label runat="server" CssClass="lblUser1" ID="lblUserName"></asp:Label></a>
            </div>
        ...
        <div class="wrap">
        	...
        	<div class="tz-ship-list">
                ...
                <table width="100%" border="0">
                    <tr style="text-align:center; font-size:14px; font-weight:600; text-decoration:none; line-height:17px; ">
                    <td>
            ...
            <div>
                <asp:Repeater runat="server" ID="rpt_Account_Stmt" OnItemDataBound="rpt_DueNext7Days_Summary_ItemDataBound" >                                        
                    <HeaderTemplate>
                        <table width="100%" border="1" class="odr_tbl_list table-striped tz-table-font">
                            <tr>                                                                                             
                    ...
                    <ItemTemplate>
                        <tr>                          
                            ...
                            <td align="right" id="tddate" valign="top"  width="50%" > <div style="font-size:13px; font-weight:600; "> <%# Eval("Amount", "{0:0,00}") %> </div> <a style="font-size:12px;"> <%# Convert.ToDateTime(Eval("DueDate")).ToString("dd/MM/yy") %></a></td>
    ...
    <footer>
        <div class="fl_icon"><a href="ActCustomerDueInNext7Days.aspx"><i class="fa fa-2x fa-arrow-circle-o-left" aria-hidden="true"></i></a></div>
    	<div class="wrap">        	
        </div>       
    </footer>
</main>
