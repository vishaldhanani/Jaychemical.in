<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BlanketOrderModificationView.aspx.cs" Inherits="BlanketOrderModificationView" %>
...
<body>
        ...
        <div class="wrap">     
             <a id="lbl_home_logo"  runat="server"  href="DashBoard.aspx"><img src="images/logo.png" class="inner-logo"/></a>
                    <div class="inner_logo">          
                         <a >Blanket Order Edit <br /> <asp:Label runat="server" CssClass="lblUser1" ID="lblUserName"></asp:Label></a>                                                            
                    </div>
   ...
   <div id="middle">
        <div class="wrap">
        	...
        	<div class="addres_box">
                ...
                <table width="100%" border="0">
                      <tr>
                    <td colspan="2" style="font-size:18px; font-weight:bold; padding-bottom:3px;" align="Center" valign="top">Blanket Order Modification<br /></td>
                    </tr>

                    <tr>
                    <td  style="font-size:15px" align="left" valign="top"><asp:Label Style="text-align:left; font-weight:bold;"  ID="lbl_blanketOrderNo" runat="server" Text=""  ></asp:Label> </td>
                ...
                <table width="100%" border="0">
                  <tr>
                    <td width="30%" align="left" valign="top" style=" font-size:13px; font-weight:bold;">Customer :</td>
                    <td width="70%" align="left" valign="top" style=" font-size:13px;"><asp:Label runat="server" ID="l_CustName"></asp:Label> </td>
                  </tr>
                  <tr>
                    <td width="30%" height="41" align="left" valign="top" style=" font-size:13px; font-weight:bold;">Address :</td>
                    <td width="70%" align="left" valign="top" style=" font-size:13px;"><asp:Label runat="server" ID="l_CustAdd"></asp:Label></td>
                  </tr>
                  <tr>
                    <td width="30%" align="left" valign="top" style=" font-size:13px; font-weight:bold;">Contact No. :</td>
                ...
                <table width="100%" border="0">
                  <tr>
                    <td width="30%" align="left" valign="top" style=" font-size:13px; font-weight:bold;">Consignee:</td>
                ...
                <div class="tz-order-address" style="background-color:#fff;">
                    <table width="100%" border="0">
                        <tr>
                    <td width="100%" align="left" valign="top"><asp:TextBox runat="server" ID="txtCustomerReferenceNo" ReadOnly="true" TabIndex="1" CausesValidation="true" PlaceHolder="Purchase Order No" CssClass="u_oder_fill_white_label13" Style="width:94%;"></asp:TextBox>                                              
                    </td>
                ...
                <asp:Repeater runat="server" ID="rpt_FinalCart" OnItemDataBound="rpt_FinalCart_ItemDataBound">
                    ...
                    <FooterTemplate>
                             <tr>
                                ...
                                <th width="39%" align="center" valign="middle">TOTAL</th>
    ...
    <footer>
        <div class="fl_icon"><a href="InternalMakeOrderModification.aspx"><i class="fa fa-2x fa-arrow-circle-o-left" aria-hidden="true"></i></a></div>
    	<div class="wrap">
